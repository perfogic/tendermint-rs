...
// TODO: Add a normalized version of `Query` (eg. `NormalizedQuery`) and use that instead,
//       to make sure that queries with different conditions ordering are treated as equal.
